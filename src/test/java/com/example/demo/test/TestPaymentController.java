...
//		Payment mockCourse = new Payment(204.)
//	}
...
//		assertEquals(expected, result);
	...
	public void testGetById() throws Exception {
		this.mock.perform(get("/payment/get/{id}", 203)
				.contentType(MediaType.APPLICATION_JSON))
        		.andExpect(status().isOk())
				.andDo(print())
				.andExpect(jsonPath("$.paymentId", Matchers.is(203) ))
				.andExpect(jsonPath("$.description", Matchers.is("creditcardpmt") ))
				.andExpect(jsonPath("$.amount", Matchers.is(4200.0) ));
	}
}
